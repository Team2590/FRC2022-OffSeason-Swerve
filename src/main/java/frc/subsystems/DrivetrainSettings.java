...
public interface DrivetrainSettings {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(121.98 +1.4); // 119
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(103.26+1.8); //106
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(286.52+1.83); //295
}
